...
import 'package:pt/data/get_credit.dart';
import 'package:pt/data/get_income.dart';

class credittotal extends StatefulWidget {
  credittotal({super.key, required this.title});

  final String title;
 

  @override
  State<credittotal> createState() {
    return _incometotalstate();
  }
}

class _incometotalstate extends State<credittotal> {
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Credit(documentid: id, color: textColor)
                ],
              ),
            ),
            SizedBox(height: 10),
